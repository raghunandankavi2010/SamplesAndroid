...
public class FeedModel implements Parcelable {
   ...
   /* {
    ...
    private ObservableArrayList<QuestionLanguageContents> languageContents = new ObservableArrayList<>();;

    public ObservableArrayList<QuestionLanguageContents> getLanguageContents ()
    {
        return languageContents;
    }

    public void setLanguageContents (ObservableArrayList<QuestionLanguageContents> languageContents)
    {
