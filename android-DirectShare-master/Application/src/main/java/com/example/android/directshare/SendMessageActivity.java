...
public class SendMessageActivity extends Activity {
    ...
    private void send() {
        ...
        if (!TextUtils.isEmpty(Contact.byId(mContactId).getNumber())) {
            SmsManager smsManager = SmsManager.getDefault();
            smsManager.sendTextMessage(Contact.byId(mContactId).getNumber(), null, mBody, null, null);
        ...
        }else if (Utility.validateEmailRegex(Contact.byId(mContactId).getName())) {

            Toast.makeText(this, "Use the email app to share the question",
                    Toast.LENGTH_SHORT).show();
            /*    Intent emailIntent = new Intent(Intent.ACTION_SEND);

                emailIntent.setData(Uri.parse("mailto:"));
                emailIntent.setType("text/plain");
                emailIntent.putExtra(Intent.EXTRA_EMAIL, Contact.byId(mContactId).getName());
...
*/
                ...
                Toast.makeText(this, Contact.byId(mContactId).getName() + " does not have a number or email to share",
                        Toast.LENGTH_SHORT).show();
            }
        /*Toast.makeText(this,
