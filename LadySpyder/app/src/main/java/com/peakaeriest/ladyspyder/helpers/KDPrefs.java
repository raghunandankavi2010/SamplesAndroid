...
import com.peakaeriest.ladyspyder.activities.LSSplashActivity;
...
public class KDPrefs {
    ...
    public void setAddressID(String setAddressID) {
        m_prefsWrite.putString("setAddressID", setAddressID);
        m_prefsWrite.commit();
    }

    public String getAddressID() {
        return m_prefsRead.getString("setAddressID", null);
    }
