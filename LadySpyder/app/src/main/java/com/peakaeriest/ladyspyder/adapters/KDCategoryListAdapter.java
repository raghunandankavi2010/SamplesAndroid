...
public class KDCategoryListAdapter extends BaseExpandableListAdapter {
    ...
    public KDCategoryListAdapter(Context context, List<String> listDataHeader, HashMap<String, List<GetMainCategoryResponse.SubCategory>> listChildData) {
