...
import com.peakaeriest.ladyspyder.utils.DateTimeUtils;
import com.peakaeriest.ladyspyder.utils.VectorDrawableUtils;
 ...
 */
public class LSTimeLineAdapter extends RecyclerView.Adapter<LSTimeLineViewHolder> {
    ...
    public LSTimeLineAdapter(List<TimeLineModel> feedList, Orientation orientation, boolean withLinePadding) {
        mFeedList = feedList;
    ...
    @Override
    public LSTimeLineViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new LSTimeLineViewHolder(view, viewType);
    }

    @Override
    public void onBindViewHolder(LSTimeLineViewHolder holder, int position) {
