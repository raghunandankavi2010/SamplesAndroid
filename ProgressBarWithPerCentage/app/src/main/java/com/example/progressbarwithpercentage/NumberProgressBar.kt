...
class NumberProgressBar @JvmOverloads constructor(
    ...
    private fun calculateDrawRectF() {
        ...
        if (progress == 0) {
            ...
            mTextPaint!!.getTextBounds(mCurrentDrawText, 0, mCurrentDrawText!!.length, bounds)
            mDrawTextWidth = bounds.width().toFloat()
            ...
            mReachedRectF.bottom = height / 2.0f + reachedBarHeight / 2.0f
            mDrawTextStart = mReachedRectF.right - mOffset - mDrawTextWidth
        }
        mDrawTextEnd =
