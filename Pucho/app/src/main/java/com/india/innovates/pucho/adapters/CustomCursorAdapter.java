...
import com.india.innovates.pucho.models.QuestionAskedBy;
...
public class CustomCursorAdapter extends CursorRecyclerViewAdapter<CustomCursorAdapter.ViewHoldera> {
    ...
    public void onBindViewHolder(ViewHoldera holder, Cursor cursor) {
        ...
        viewHolder.question.setText(cursor.getString(cursor.getColumnIndex(FavoriteContract.Favorite.QUESTION_CONTENT)), TextView.BufferType.SPANNABLE);
