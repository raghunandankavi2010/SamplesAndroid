...
import com.raghu.quiz.helper.ItemTouchHelperAdapter;
import com.raghu.quiz.helper.ItemTouchHelperViewHolder;
...
public class RecyclerListAdapter extends RecyclerView.Adapter<RecyclerListAdapter.ItemViewHolder>
    ...
    public RecyclerListAdapter(Context context, OnStartDragListener dragStartListener, OnListChangedListener onListChangedListener) {
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        ...
        //holder.textView.setCode(mItems.get(position));
    ...
    public boolean onItemMove(int fromPosition, int toPosition) {
        ...
        onListChangedListener.onNoteListChanged(mItems);
