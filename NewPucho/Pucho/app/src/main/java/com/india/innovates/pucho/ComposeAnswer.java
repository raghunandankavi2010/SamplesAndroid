...
public class ComposeAnswer extends AppCompatActivity implements ComposeAnswerScreen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getResources().getString(R.string.compose_answer));
    ...
    public void onEvent(String check) {
        ...
        if(check.equals("Empty")) {
            postAnswereditText.setError("Content cannot be Empty!.Body must contain 10 characters");
        }
    ...
    public void onEvent(PostAnswerResponseEvent postAnswerResponseEvent)
    {
       int id =  postAnswerResponseEvent.getPostAnswerResponseList().get(0).getId();
        ...
        Log.i(TAG,"Id is "+id);
        finish();
        Toast.makeText(getApplicationContext(),"You have answered the question successfully",Toast.LENGTH_SHORT).show();
    }
